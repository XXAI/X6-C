...
error_descargar(obj)
{
  ...
  error_envio(obj)
  {
    ...
    editar(obj:any)
    {
      this.reset_form();
      this.showregistro = true;  
      this.registrosModule.patchValue({reaccion:obj.reaccion, folio: obj.folio, id_verificacion:obj.verificacion.id, no_verificacion:obj.verificacion.folio, institucion: obj.verificacion.establecimiento});
