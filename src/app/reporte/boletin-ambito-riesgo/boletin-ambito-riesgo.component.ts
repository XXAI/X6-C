...
@Component({
  selector: 'app-boletin-ambito-riesgo',
  templateUrl: './boletin-ambito-riesgo.component.html',
  styleUrls: ['./boletin-ambito-riesgo.component.css']
})
export class BoletinAmbitoRiesgoComponent implements OnInit {
...
//options_muestra_total: Object;
  ...
  ngOnInit() {
    ...
    this.title.setTitle("Reporte Ambito Riesgo");
    
  }

  listar(id_ambito:number):void{
  ...
  filtro(id_ambito):void
  {
    this.listar(id_ambito);
  }
