...
export class ListaComponent implements OnInit {
  ...
  ngOnInit() {
    this.title.setTitle("Registro Dictamen");
    ...
    var busquedaSubject = this.terminosBusqueda
        ...
        if(this.busqueda.buscarText.length == 0 && this.busqueda.id_jurisdiccion == 0)
        {
	      ...
	      this.cargando = true;
	      return term  ? this.DictamenService.buscar_detalle(term, this.paginaActualBusqueda, this.resultadosPorPaginaBusqueda) : Observable.of<any>({data:[]}) 
	    }
  ...
  listarBusqueda(term:string ,pagina:number): void {
    ...
    this.cargando = true;
    this.DictamenService.buscar_detalle(term, pagina, this.resultadosPorPaginaBusqueda).subscribe(
        resultado => {
          this.cargando = false;
  ...
  listar(pagina:number): void {
    ...
    this.DictamenService.lista(pagina,this.resultadosPorPagina).subscribe(
        resultado => {
          ...
          this.cargando = false;
          this.dictamen = resultado.data as Dictamen[];
