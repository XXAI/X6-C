...
@Component({
  selector: 'app-lista-determinacion',
  templateUrl: './lista-determinacion.component.html',
  styleUrls: ['./lista-determinacion.component.css']
})
export class ListaDeterminacionComponent implements OnInit {

  tamano = document.body.clientHeight;

  id_tipo_programacion:number = 6;
