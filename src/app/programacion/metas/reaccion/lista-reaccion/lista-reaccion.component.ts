...
@Component({
  selector: 'app-lista-reaccion',
  templateUrl: './lista-reaccion.component.html',
  styleUrls: ['./lista-reaccion.component.css']
})
export class ListaReaccionComponent implements OnInit {
