...
@Component({
  selector: 'app-lista-muestra',
  templateUrl: './lista-muestra.component.html',
  styleUrls: ['./lista-muestra.component.css']
})
export class ListaMuestraComponent implements OnInit {

  tamano = document.body.clientHeight;

  id_tipo_programacion:number = 2;
